...
aria2c --no-conf --console-log-level=warn --log-level=info --log="aria2_download.log" -o"$tempScript" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=5662000d-11c7-40e1-bec3-357197281653&pack=en-us&edition=core%3Bprofessional&aria2=2"
if [ $? != 0 ]; then
