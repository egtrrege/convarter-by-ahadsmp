@echo off
:: Generated on 2026-05-02 16:19:37 GMT
...
:START_PROCESS
title 26100.8328_amd64_en-us_multi_5662000d download
...
"%aria2%" --no-conf --async-dns=false --console-log-level=warn --log-level=info --log="aria2_download.log" -o"%aria2Script%" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=5662000d-11c7-40e1-bec3-357197281653&pack=neutral&edition=app&aria2=2"
...
"%aria2%" --no-conf --async-dns=false --console-log-level=warn --log-level=info --log="aria2_download.log" -o"%aria2Script%" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=5662000d-11c7-40e1-bec3-357197281653&pack=en-us&edition=core%%3Bprofessional&aria2=2"
if %ERRORLEVEL% GTR 0 call :DOWNLOAD_ERROR & exit /b 1
echo.
